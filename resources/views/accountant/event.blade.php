    ...
    <div class="panel-heading">New Event</div>
        ...
        <div class="row"> 
            ...
            <div class="col-md-10 col-md-offset-1">                   
                ...
                <div class ><input type="text" class="form-control" placeholder="description" required></div>
                <div class ><input type="date" class="form-control" placeholder="deadline" value="{{ Carbon\Carbon::now()->toDateTimeString() }}"></div>
